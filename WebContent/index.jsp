<%@ page import="basic.Basic"%>
<%@ page import="basic.BasicImpl"%>
<%@ page import="basic.SendEmail"%>
<html lang="en">
  <head>
  ...
  <body>
    ...
    <jsp:useBean id="test" class="basic.Basic" />
  <%
   Basic tc = new Basic();
   tc.testMethod();
      ...
      <section class="ftco-section-2">
	      <div class="container-fluid">
	        <div class="section-2-blocks-wrapper d-flex row no-gutters">
	          <div class="img col-md-6 ftco-animate" style="background-image: url('images/gameOfThrones1.jpg');">
	          </div>
